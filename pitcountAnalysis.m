...
function data = pitcountAnalysis(varargin)
...
if numel(data(1).channels)>1
    runSlaveChannelClassification(data, opts{:}, 'np', 5000, 'MasterCh', ip.Results.MasterCh,'Alpha',0.0001);
end

countTracks(data,'ChannelNames',ip.Results.ChannelNames);